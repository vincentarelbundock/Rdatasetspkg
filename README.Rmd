...
Access thousands of datasets from various R packages through the Rdatasets archive. This package provides a simple interface to search, download, and view documentation for datasets stored in both CSV and Parquet formats.
