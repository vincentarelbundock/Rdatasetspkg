...
#' - `Rdatasets_format`: String
#'   - Output format for returned data. One of "data.frame" (default), "tibble", or "data.table". Default: `"data.frame"`. Requires the respective packages to be installed for "tibble" or "data.table" formats.
#'   - Ex: `options(Rdatasets_format = "tibble")`
